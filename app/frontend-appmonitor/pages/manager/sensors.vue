<template>
    <div>
        ...
        <div class="max-w-4xl mx-auto mt-6 p-5 bg-white rounded-lg shadow-md">
            <h2 class="text-2xl font-semibold mb-4">Sensors Page</h2>
            ...
            <div v-if="!loading && !error" class="table-container">
                <table aria-label="sensors table" class="table w-full">
                    <thead>
                        <tr>
                            <th class="p-3 font-semibold text-left">Sensor ID</th>
                            <th class="p-3 font-semibold text-left">Sensor Type</th>
...
// Function to View Sensor Details
const viewSensorDetails = (sensorId) => {
    console.log("Navigating to sensorDetails with id:", sensorId);  
